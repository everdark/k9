...
if os.path.exists(lgb_model_file):
  ...
  # https://github.com/microsoft/LightGBM/pull/1495/files
...
lgb.plot_importance(lgbooster, max_num_features=20)  # TODO: This won't show.
```
...
@nori2019interpretml open source the package `interpret` for a fast implementation of **Generalized Additive Models with Pairwise Interactions, or GA<sup>2</sup>M** (@lou2013accurate).
...
Explainable boosting machine (EBM hereafter) is an additive model of the form:
