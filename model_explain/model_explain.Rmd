...
@nori2019interpretml open source the package `interpret` for a fast implementation of **Generalized Additive Models with Pairwise Interactions** (GA<sup>2</sup>M, @lou2013accurate).
