...
rf_shap_values = rf_shape_explainer.shap_values(X_test_d)
...
top_k = 20
shap.summary_plot(rf_shap_values, X_test_d, feature_names=sorted_vocab, max_display=top_k, plot_size=.25)
```
...
d_train = lgb.Dataset(X_train, label=y_train, feature_name=sorted_vocab)
d_test = lgb.Dataset(X_test, label=y_test, feature_name=sorted_vocab)
