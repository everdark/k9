...
Mathematically the gradient update from the negative sampling loss is asymptotically the same to the update when a softmax probability is used.
...
Since practically there is little difference between the two approaches we will skip the discussion on NCE loss for simplicity.

### Pre-trained `word2vec`

### Train from Scratch

[tf.keras implementation here]
...
wv_main <- glove$fit_transform(tcm, n_iter=10, convergence_tol=.01)
