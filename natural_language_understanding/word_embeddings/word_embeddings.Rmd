...
model.compile(loss="binary_crossentropy", optimizer=tf.keras.optimizers.SGD(.025))
...
# NOTE:
# fit() is buggy in 2.0.0 stable release, use fit_generator() instead for a workaround.
