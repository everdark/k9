...
This will introduce exponetially more steps for item 4 embeddings to be updated since each interacted item in a user vector will be compared against the user's other interacted items.
