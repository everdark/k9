...
Though our implementation will still be naive without much engineering optimization,
...
class MatrixFactorization:
  def __init__(self, R, k, lr=.0003, l2=.04, seed=777):
    ...
    self.P = tf.Variable(weight_init((self.m, self.k)))
    self.Q = tf.Variable(weight_init((self.n, self.k)))
...
class RealValueMF(MatrixFactorization):
  def loss(self):
    ...
    l2_norm = tf.reduce_sum(P**2) + tf.reduce_sum(Q**2)
