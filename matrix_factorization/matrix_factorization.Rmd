...
Though not particularly discussed in our previous secions,
...
The optimization problem can be solved in exactly the same manner,
just add on two additional weight vectors to learn.
