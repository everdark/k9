...
\begin{aligned}
L(p_u, q_i, r_{ui})
&= \sum_{u, i \in R} c_{ui} \cdot \big( \delta_{ui} - p_u^Tq_i \big)^2 \\
&= \sum_{u, i \in R} \big(1 + \alpha r_{ui}\big)\big( \delta_{ui} - p_u^Tq_i \big)^2.
\end{aligned}
$$
...
To efficiently learn the user and item embeddings,
