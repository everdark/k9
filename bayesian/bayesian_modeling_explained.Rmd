...
The integral is usually analytically untractable,
...
let's consider another example with analytical solution avalable.
...
As one can see,
the resulting MCMC samples can no longer approximate the theoretical limiting distribution of the sample mean.
...
$$
\begin{aligned}
P(y = 1) &= \frac{1}{1+e^{-(X\beta+\epsilon)}}, \\
