...
with binom_model:
    # Priors.
    theta = ... # A Uniform distribution--flat prior.

    # Likelihood of observations.
    yobs = ... # The observation follows a Binomial distribution.
...
with logit_model:
    # Priors.
    beta = ... # Assume a standard Normal for all coefficients.

    # Model output.
    yhat = ... # sigmoid(logits); logits = dot product of X and beta.

    # Likelihood of observations.
    yobs = ... # y is binary, following a Bernoulli distribution.
...
with linear_model:
    # Priors.
    beta = ... # Assume Normality but with a higher s.d. to allow for less information.
    sigma = ... # Truncated standard Normal with only non-negative values.

    # Model output.
    yhat = ... # Dot product of X and beta.

    # Likelihood of observations.
    yobs = # y should follow the error term distribution, with the mean value parameterized by the linear model.
