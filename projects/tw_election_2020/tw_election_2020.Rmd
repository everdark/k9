...
link-citations: yes
abstract: |
  The notebook provides some visual analytics on the 2020 Taiwanese presidential and legislative election results. The polling took place at 2020-01-11 and data has been collected by Central Election Commision (CEC) at the polling place level.
---
...
```{r presidential_county_turnout_vsd, fig.cap="2020 Presidential Election Voter Turnout by County"}
