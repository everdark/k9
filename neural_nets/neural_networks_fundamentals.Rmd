...
The general idea is to constraint the calculated gradients before applying backpropagation update.
...
Another way of doing that is to constrain by a given L2 norm value:
