...
The gradient in our univariate model w.r.t. the bias term will be:

$$
\begin{aligned}
\frac{\partial\mbox{LogLoss}}{\partial\beta_0} 
&= - \frac{1}{N}\sum_i \big[ y_i(1 - q_i) - (1 - y_i)q_i \big] \\
...
Since our naive implementation does not do convergence dignostics,
