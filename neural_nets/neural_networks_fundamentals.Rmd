...
use_condaenv("D:/Users/fcdyuc/anaconda3/python")
```
...
p = plot_offline(
  ...
  layout=go.Layout(
    ...
    showlegend=True,
    xaxis=dict(title=r"$w_{1}$", range=[-t*1.5, t*1.5]),
    yaxis=dict(title=r"$w_{2}$", range=[-t*1.5, t*1.5], scaleanchor="x", scaleratio=1),
    shapes=[
      dict(type="circle", x0=-t, y0=-t, x1=t, y1=t, line=dict(color="darkgreen")),
