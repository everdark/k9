...
then a Normal prior on the weight will result in a maximum a posteriori estimator to have a target function with the l2 regularization term,
and a [Laplacean](https://en.wikipedia.org/wiki/Laplace_distribution) prior will result in the l1 term.
