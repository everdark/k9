...
Now we have solved the weights that minimize the cost.
We will also need the optimized cost to determine the best split.
The best split should result in two nodes such that the total cost of two nodes is reduced the most from their parent node.

**TODO: built-from-scratch implementation?**
