...
- name: Kyle Chung
  affiliation:
date: "`r format(Sys.time(), '%d %b %Y')` Last Updated (25 Jun 2019 First Uploaded)"
output:
  html_notebook:
    number_sections: yes
    theme: paper
...
-->
<script src="../../../site_libs/utils/plotly-1.48.3.min.js"></script>
...
meta <- c(
  ...
  '<meta property="og:url" content="https://everdark.github.io/k9/notebooks/ml/neural_nets/neural_networks_fundamentals.nb.html">',
...
github_corner_conf <- list(github_link="https://github.com/everdark/k9/tree/master/notebooks/ml/neural_nets")
...
ofile = "/tmp/toy_reg_loss_compare.html"
...
ofile = "/tmp/toy_reg_sgd_loss.html"
p = plot_offline(
  ofile=ofile,
...
ofile = "/tmp/loss_contour_reg.html"
p = plot_offline(
  ofile=ofile,
  data=[
    go.Contour(
