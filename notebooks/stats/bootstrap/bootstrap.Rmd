...
To avoid such bias,
increasing sample size is one solution,
but another solution which is more feasible is to use the t-statistic,
which we will discuss latter in the next hands-on example.
